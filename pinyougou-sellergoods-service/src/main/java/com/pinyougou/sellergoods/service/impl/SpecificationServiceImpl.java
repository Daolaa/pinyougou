...
public class SpecificationServiceImpl implements SpecificationService {
    ...
    public void add(Specification specification) {
        ...
        for (TbSpecificationOption specificationOption : list) {
            ...
            specificationOptionMapper.insert(specificationOption);//插入规格
        }
    }
    ...
    public void update(Specification spec) {
        ...
        //循环插入新的规格参数
        List<TbSpecificationOption> list = spec.getSpecificationOptionList();
        for (TbSpecificationOption tbSpecificationOption : list) {
            tbSpecificationOption.setSpecId(spec.getSpecification().getId());
